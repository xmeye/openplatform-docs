...
<table >
<tr><td style="background-color:#ccc;text-align:center;width:35px;">定义</td><td colspan="2">void Fun_LogInit(UI_HANDLE hUser, const char *szServerIP, int nServerPort, const char *szLogFile, int nLogLevel = 0x3);</td></tr>
...
<td>
日志级别：LOG_UI_MSG ：通过EUIMSG .EMSG_EMSG_APP_ON_MSG_LOG消息发给hUser
...
<td>消息值：EUIMSG   .EMSG_ELOG_MSG_INIT</td></tr>
...
<table >
<tr><td style="background-color:#ccc;text-align:center;width:35px;">定义</td><td colspan="2">void Fun_SendLogFile(const char *szLog)</td></tr>
...
<tr><td style="text-align:center">id</td>
<td>消息值：EUIMSG   . EMSG_ELOG_MSG_SEND_FILE</td></tr>
...
<tr><td style="text-align:center">id</td>
<td>消息值：EUIMSG   . EMSG_ELOG_APP_CRASH</td></tr>
<tr><td style="text-align:center">arg1</td>
<td>==EE_OK：成功；<0：失败，详见错误码说明</td></tr>
</table>
...
<table >
<tr><td style="background-color:#ccc;text-align:center;width:35px;">定义</td><td colspan="2">Schar* Fun_GetErrorInfoByEId(int nEId, char strError[512]);</td></tr>
